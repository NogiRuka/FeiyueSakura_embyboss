...
from bot.filters import admins_on_filter, user_in_group_on_filter
from bot.ui.aiogram_buttons import sched_buttons, plays_list_button
from bot.messaging.msg_utils import callAnswer, editMessage, deleteMessage
...
async def restart_bot(_, msg):
    ...
    try:
        # some code here
        LOGGER.info("重启")
        os.execl('/bin/systemctl', 'systemctl', 'restart', 'lustfulservicebot')  # 用当前进程执行systemctl命令，重启服务
